...
export default function PaymentScreen() {
  ...
  // Expo Router parameters can sometimes be returned as an array.
  ...
  const loadPayment = async () => {
    ...
    try {
      ...
      if (data?.paymentMethod) {
        setSelectedMethod(data.paymentMethod.toUpperCase());
      }
    } catch (error) {
  ...
  const createPayment = async () => {
    if (!isReadyForPayment) {
      Alert.alert("Payment error", "We could not identify your order.");
      return;
    }
  ...
  if (!isReadyForPayment) {
    return (
      <View style={styles.loadingScreen}>
        ...
        >
          We could not identify the order for this payment.
        </Text>
  ...
  if (loadError) {
    return (
      <View style={styles.loadingScreen}>
        ...
        <Pressable style={styles.primaryButton} onPress={loadPayment}>
      ...
      >
        <View style={styles.orderCard}>
          ...
          <View style={styles.orderInfo}>
            ...
            <Text style={styles.orderNumber}>#{numericOrderId}</Text>
        ...
        {payment && (
          <View
            style={[
              styles.statusCard,
              isSuccessful && styles.successStatusCard,
              isFailed && styles.failedStatusCard,
            ]}
          >
          ...
          <View style={styles.section}>
            ...
            <View style={styles.methods}>
              <Pressable
                style={[
                  styles.methodCard,
                  selectedMethod === CARD_METHOD && styles.methodCardSelected,
                ]}
                onPress={() => setSelectedMethod(CARD_METHOD)}
                disabled={processing}
              >
                ...
                <View
                  style={[
                    styles.radioOuter,
                    selectedMethod === CARD_METHOD && styles.radioSelected,
                  ]}
                >
              ...
              <Pressable
                style={[
                  styles.methodCard,
                  selectedMethod === EFT_METHOD && styles.methodCardSelected,
                ]}
                onPress={() => setSelectedMethod(EFT_METHOD)}
                disabled={processing}
              >
                <View style={styles.methodIcon}>
                  <Text style={styles.methodEmoji}>🏦</Text>
                ...
                <View style={styles.methodContent}>
                  <Text style={styles.methodTitle}>EFT</Text>
                  <Text style={styles.methodDescription}>
                ...
                <View
                  style={[
                    styles.radioOuter,
                    selectedMethod === EFT_METHOD && styles.radioSelected,
                  ]}
                >
                  {selectedMethod === EFT_METHOD && (
                    <View style={styles.radioInner} />
                  )}
                </View>
              </Pressable>
              ...
              <Pressable
                style={[
                  styles.methodCard,
                  selectedMethod === CASH_METHOD && styles.methodCardSelected,
                ]}
                onPress={() => setSelectedMethod(CASH_METHOD)}
                disabled={processing}
              >
                <View style={styles.methodIcon}>
                  <Text style={styles.methodEmoji}>💵</Text>
                ...
                <View
                  style={[
                    styles.radioOuter,
                    selectedMethod === CASH_METHOD && styles.radioSelected,
                  ]}
                >
                  {selectedMethod === CASH_METHOD && (
                    <View style={styles.radioInner} />
                  )}
                </View>
              </Pressable>
        ...
        <View style={styles.demoNotice}>
          <Text style={styles.demoNoticeTitle}>Development payment</Text>

          <Text style={styles.demoNoticeText}>
            This version uses the backend's payment simulation endpoints. A real
